 ...
 */
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=function(e){var t=decodeURIComponent(e)||null,n={},r=t&&t.match(/[?&][^?&]+=[^?&]+/g);return r&&r.forEach((function(e){var t=e.substring(1).split("="),r=t[0],o=t[1];n[r]=o})),n},t=function(e,t){if("number"!=typeof e||"number"!=typeof t)throw new Error("param must is number");var n=t-e+1;return Math.floor(Math.random()*n+e)},n=function(e){if(0===(null==e?void 0:e.length))throw"the length of Array is 0";return e.reduce((function(e,t){return e+t}))},r=function(e){if(!(e instanceof Array))throw new Error("compareArrayKey(): Argument must be an Array");var t;e.sort((t="name",function(e,n){var r=e[t],o=n[t];return r<o?-1:r>o?1:0}))};function o(e){return("00"+e).substr(e.length)}var i=function(e,t){/(y+)/.test(t)&&(t=t.replace(RegExp.$1,(""+e.getFullYear()).substr(4-RegExp.$1.length)));var n={"M+":e.getMonth()+1,"d+":e.getDate(),"h+":e.getHours(),"m+":e.getMinutes(),"s+":e.getSeconds()};for(var r in n)if(new RegExp("("+r+")").test(t)){var i=""+n[r];t=t.replace(RegExp.$1,1===RegExp.$1.length?i:o(i))}return t},a=function(e,t,n){if(!e)throw new Error("获取的文件流为空");var r=new Blob([e],{type:n||"application/pdf;chartset=UTF-8"}),o=e.name||t||"默认名字";if("download"in document.createElement("a")){var i=document.createElement("a");i.download=o,i.style.display="none",i.href=URL.createObjectURL(r),document.body.appendChild(i),i.click(),URL.revokeObjectURL(i.href),document.body.removeChild(i)}else window.navigator.msSaveBlob(r,o)},l=function(e,t){var n=new XMLHttpRequest;n.open("GET",e,!0),n.responseType="blob",n.onload=function(){var e=n.response;if("msSaveOrOpenBlob"in navigator)window.navigator.msSaveOrOpenBlob(e,t);else{var r=document.createElement("a");r.download=t,r.href=window.URL.createObjectURL(e),document.body.appendChild(r),r.click(),r.remove()}},n.send()};var s,d,c,u=(s=function(e,t){var n;window,n=function(){return function(e){var t={};function n(r){if(t[r])return t[r].exports;var o=t[r]={i:r,l:!1,exports:{}};return e[r].call(o.exports,o,o.exports,n),o.l=!0,o.exports}return n.m=e,n.c=t,n.d=function(e,t,r){n.o(e,t)||Object.defineProperty(e,t,{enumerable:!0,get:r})},n.r=function(e){"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})},n.t=function(e,t){if(1&t&&(e=n(e)),8&t)return e;if(4&t&&"object"==typeof e&&e&&e.__esModule)return e;var r=Object.create(null);if(n.r(r),Object.defineProperty(r,"default",{enumerable:!0,value:e}),2&t&&"string"!=typeof e)for(var o in e)n.d(r,o,function(t){return e[t]}.bind(null,o));return r},n.n=function(e){var t=e&&e.__esModule?function(){return e.default}:function(){return e};return n.d(t,"a",t),t},n.o=function(e,t){return Object.prototype.hasOwnProperty.call(e,t)},n.p="",n(n.s=0)}({"./src/index.js":
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
...
/*!****************************!*\
  !*** multi ./src/index.js ***!
  \****************************/
/*! no static exports found */function(e,t,n){e.exports=n(/*! ./src/index.js */"./src/index.js")}}).default},e.exports=n()},s(d={exports:{}},d.exports),d.exports),f=(c=u)&&c.__esModule&&Object.prototype.hasOwnProperty.call(c,"default")?c.default:c,p=function(e){if(!e)throw new Error("id是必填的额");f({printable:e||"contentPrint",type:"html",targetStyles:["*"],ignoreElements:["noButton"]})},m=function(e,t){if(!e)throw new Error("url是必填的额");f({printable:e,type:"pdf",targetStyles:["*"],base64:t||!1,onLoadingStart:function(){console.log("开始")},onLoadingEnd:function(){console.log("结束了。。。。")},onPrintDialogClose:function(){console.log("关闭了。。")},ignoreElements:["noButton"]})},b={urlParse:e,formatDate:i,downFileBlob:a,downFileUrl:l,htmlPrint:p,urlPrint:m,selectRandomValue:t,addNums:n,compareArrayKey:r};exports.addNums=n,exports.compareArrayKey=r,exports.default=b,exports.downFileBlob=a,exports.downFileUrl=l,exports.formatDate=i,exports.htmlPrint=p,exports.selectRandomValue=t,exports.urlParse=e,exports.urlPrint=m;
