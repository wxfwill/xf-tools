...
/*!****************************!*\
      !*** multi ./src/index.js ***!
      \****************************/
/*! no static exports found */function(e,t,n){e.exports=n(/*! ./src/index.js */"./src/index.js")}}).default},e.exports=n()})),a=(o=i)&&o.__esModule&&Object.prototype.hasOwnProperty.call(o,"default")?o.default:o;var l=Object.freeze({__proto__:null,htmlPrint:e=>{if(!e)throw new Error("id是必填的额");a({printable:e||"contentPrint",type:"html",targetStyles:["*"],ignoreElements:["noButton"]})},urlPrint:(e,t)=>{if(!e)throw new Error("url是必填的额");a({printable:e,type:"pdf",targetStyles:["*"],base64:t||!1,onLoadingStart:()=>{console.log("开始")},onLoadingEnd:()=>{console.log("结束了。。。。")},onPrintDialogClose:()=>{console.log("关闭了。。")},ignoreElements:["noButton"]})}});var s=Object.freeze({__proto__:null,downFileBlob:(e,t,n)=>{if(!e)throw new Error("获取的文件流为空");const r=new Blob([e],{type:n||"application/pdf;chartset=UTF-8"}),o=e.name||t||"默认名字";if("download"in document.createElement("a")){const e=document.createElement("a");e.download=o,e.style.display="none",e.href=URL.createObjectURL(r),document.body.appendChild(e),e.click(),URL.revokeObjectURL(e.href),document.body.removeChild(e)}else window.navigator.msSaveBlob(r,o)},downFileUrl:(e,t)=>{let n=new XMLHttpRequest;n.open("GET",e,!0),n.responseType="blob",n.onload=()=>{let e=n.response;if("msSaveOrOpenBlob"in navigator)window.navigator.msSaveOrOpenBlob(e,t);else{let n=document.createElement("a");n.download=t,n.href=window.URL.createObjectURL(e),document.body.appendChild(n),n.click(),n.remove()}},n.send()}});const d=Object.assign(Object.assign(Object.assign(Object.assign({},t),r),l),s),{urlParse:c,formatDate:u,downFileBlob:f,downFileUrl:p,htmlPrint:m,urlPrint:b,selectRandomValue:y,addNums:h}=d;e.addNums=h,e.default=d,e.downFileBlob=f,e.downFileUrl=p,e.formatDate=u,e.htmlPrint=m,e.selectRandomValue=y,e.urlParse=c,e.urlPrint=b,Object.defineProperty(e,"__esModule",{value:!0})}));
