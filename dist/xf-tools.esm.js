 ...
 * @return {*}
 */
var selectRandomValue = function (min, max) {
 ...
 * @return {*}
 */
var addNums = function (arr) {
    if ((arr === null || arr === void 0 ? void 0 : arr.length) === 0) {
        throw "the length of Array is 0";
    }
    var allNum = arr.reduce(function (prev, cur) {
        return prev + cur;
    });
    return allNum;
};
// 比较函数
var compareFunction = function (name) {
 ...
 * @return {*}
 */
var compareArrayKey = function (arr) {
 ...
 * file 当前文件
 */
var downFileBlob = function (res, name, type) {
    if (!res) {
 ...
 * @param {} url  pdf地址
 */
var downFileUrl = function (url, fileName) {
 ...
 */
var urlPrint = function (url, isbase64) {
    if (!url) {
...
var Tools = {
    ...
    downFileBlob: downFileBlob,
    downFileUrl: downFileUrl,
    htmlPrint: htmlPrint,
    urlPrint: urlPrint,
    selectRandomValue: selectRandomValue,
    addNums: addNums,
    compareArrayKey: compareArrayKey,
};

export { addNums, compareArrayKey, Tools as default, downFileBlob, downFileUrl, formatDate, htmlPrint, selectRandomValue, urlParse, urlPrint };
